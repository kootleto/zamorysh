...
def mod_vital(gs, vital, delta):
    ...
    ui_api.log("MOD VITAL", vital, delta, log_type="intent")
...
def set_stat(gs, stat, value):
    ...
    ui_api.log("SET STAT", stat, value, log_type="intent")


def mod_stat(gs, stat, delta):
    gs["intents"].append({"type": "stat", "target": stat, "op": "mod", "value": delta})
    ui_api.log("MOD STAT", stat, delta, log_type="intent")
...
def set_flag(gs, flag, value):
    ...
    ui_api.log("SET FLAG", flag, value, log_type="intent")
