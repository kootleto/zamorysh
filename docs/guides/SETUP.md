...
По умолчанию, если название merge-коммита не указано через `-m "Add commit name here"`, Git открывает в терминале редактор Vim, в котором записано название по умолчанию, чтобы пользователь мог его изменить. Выполните эту команду, чтобы не закрывать Vim каждый раз вручную:
